...
<section class="example">
	...
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography2.jpg"  alt=""  data-bgposition="-250px center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	style="z-index: 6; line-height: 22px;font-family:Arial;"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb1.jpg" alt="" width="300" height="200" data-ww="['250px','150px','150px','150px']" data-hh="['167px','100px','100px','100px']" data-no-retina>
	</div>
	...
	style="z-index: 7; line-height: 22px;font-family:Arial;"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb5.jpg" alt="" width="300" height="200" data-ww="['250px','150px','150px','150px']" data-hh="['167px','100px','100px','100px']" data-no-retina>
	</div>
	...
	style="z-index: 8; line-height: 22px;font-family:Arial;"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb3.jpg" alt="" width="300" height="200" data-ww="['250px','150px','150px','150px']" data-hh="['167px','100px','100px','100px']" data-no-retina>
	</div>
	...
	style="z-index: 9; line-height: 22px;font-family:Arial;"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb2.jpg" alt="" width="300" height="200" data-ww="['250px','150px','150px','150px']" data-hh="['167px','100px','100px','100px']" data-no-retina>
	</div>
	...
	style="z-index: 10; line-height: 22px;font-family:Arial;"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb4.jpg" alt="" width="300" height="200" data-ww="['250px','150px','150px','150px']" data-hh="['167px','100px','100px','100px']" data-no-retina>
	</div>
	...
	style="z-index: 11; line-height: 22px;font-family:Arial;"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb6.jpg" alt="" width="300" height="200" data-ww="['250px','150px','150px','150px']" data-hh="['167px','100px','100px','100px']" data-no-retina>
	</div>
	</li>
	<!-- SLIDE  -->
	<li data-index="rs-165" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="<?php bloginfo('template_url'); ?>/images/photography3-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Project 1" data-description="">
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography3.jpg"  alt=""  data-bgposition="center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgsize="cover" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	<!-- SLIDE  -->
	<li data-index="rs-166" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="<?php bloginfo('template_url'); ?>/images/photography4-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Project 2" data-description="">
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography4.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	<!-- SLIDE  -->
	<li data-index="rs-167" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="<?php bloginfo('template_url'); ?>/images/photography5-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Project 3" data-description="">
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography5.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	<!-- SLIDE  -->
	<li data-index="rs-168" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="<?php bloginfo('template_url'); ?>/images/photography6-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Project 4" data-description="">
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography6.jpg"  alt=""  data-bgposition="center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	<!-- SLIDE  -->
	<li data-index="rs-169" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="<?php bloginfo('template_url'); ?>/images/photography7-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Project 5" data-description="">
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography7.jpg"  alt=""  data-bgposition="center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	<!-- SLIDE  -->
	<li data-index="rs-170" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="<?php bloginfo('template_url'); ?>/images/photography8-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Project 6" data-description="">
	<!-- MAIN IMAGE -->
	<img src="<?php bloginfo('template_url'); ?>/images/photography8.jpg"  alt=""  data-bgposition="center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
	<!-- LAYERS -->
	...
	style="z-index: 14; line-height: 22px;font-family:Arial;border-color:rgba(255, 255, 255, 0);"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb1.jpg" alt="" width="300" height="200" data-ww="['70px','70px','70px','70px']" data-hh="['47px','47px','47px','47px']" data-no-retina>
	</div>
	...
	style="z-index: 15; line-height: 22px;font-family:Arial;border-color:rgba(255, 255, 255, 0);"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb5.jpg" alt="" width="300" height="200" data-ww="['70px','70px','70px','70px']" data-hh="['47px','47px','47px','47px']" data-no-retina>
	</div>
	...
	style="z-index: 16; line-height: 22px;font-family:Arial;border-color:rgba(255, 255, 255, 0);"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb3.jpg" alt="" width="300" height="200" data-ww="['70px','70px','70px','70px']" data-hh="['47px','47px','47px','47px']" data-no-retina>
	</div>
	...
	style="z-index: 17; line-height: 22px;font-family:Arial;border-color:rgba(255, 255, 255, 0);"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb2.jpg" alt="" width="300" height="200" data-ww="['70px','70px','70px','70px']" data-hh="['47px','47px','47px','47px']" data-no-retina>
	</div>
	...
	style="z-index: 18; line-height: 22px;font-family:Arial;border-color:rgba(255, 255, 255, 0);"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb4.jpg" alt="" width="300" height="200" data-ww="['70px','70px','70px','70px']" data-hh="['47px','47px','47px','47px']" data-no-retina>
	</div>
	...
	style="z-index: 19; line-height: 22px;font-family:Arial;border-color:rgba(255, 255, 255, 0);"><img src="<?php bloginfo('template_url'); ?>/images/photography_thumb6.jpg" alt="" width="300" height="200" data-ww="['70px','70px','70px','70px']" data-hh="['47px','47px','47px','47px']" data-no-retina>
	</div>
	</div>
